...
const LocationCard = () => {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      markers: [{ location: [3.1319, 101.6841], size: 0.1 }], // Malaysia coordinates
      scale: 1.05,
      onRender: (state) => {
  ...
  return (
    <div className="flex overflow-hidden relative flex-col gap-6 p-4 h-60 rounded-xl shadow-feature-card lg:p-6">

...
import me from "@/public/assets/images/alex-avatar.jpg"
  ...
  useEffect(() => {
    animate(
      [
        ...
        ["#node-js", { opacity: 1 }, { duration: 0.3 }],
        ["#pointer", { left: 50, top: 102 }, { at: "+0.5", duration: 0.5, ease: "easeInOut" }],
        ["#node-js", { opacity: 0.4 }, { at: "-0.3", duration: 0.1 }],
        ...
        ["#vue-js", { opacity: 1 }, { duration: 0.3 }],
        ["#pointer", { left: 200, top: 60 }, { at: "+0.5", duration: 0.5, ease: "easeInOut" }],
        ["#vue-js", { opacity: 0.4 }, { at: "-0.3", duration: 0.1 }],
      ],
      {
    ...
    >
      <div className='flex flex-col gap-6 rounded-[11px] p-4 lg:p-6'>
        <div className='flex gap-12 max-md:flex-col'>
          <div className='relative size-64 max-md:mx-auto min-w-64' ref={scope}>
            <BlurImage
              src={me}
              width={3975}
              height={3975}
          ...
          <div className='flex flex-col justify-center px-4'>
            <p className='bg-linear-to-r mb-2 from-black to-black/70 bg-clip-text text-3xl font-semibold text-zinc-800 dark:text-zinc-300 dark:from-zinc-100 dark:to-zinc-400'>
            ...
            <div className='my-8'>
              <a
                href='mailto:alextaymx@gmail.com'
